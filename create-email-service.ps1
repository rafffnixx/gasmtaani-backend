# create-email-service.ps1
# Run this script to create the email service without modifying existing code

$backendPath = "C:\Users\Hp\Desktop\mtaani-gas\mtaani-backend"

# Create services directory if it doesn't exist
New-Item -ItemType Directory -Force -Path "$backendPath\services"
...
# Write the email service file
$emailServiceContent | Out-File -FilePath "$backendPath\services\emailService.js" -Encoding UTF8

Write-Host "✅ Created emailService.js" -ForegroundColor Green